...
const messages = {
  ...
  admin: {
    ...
    menuError: '❌ မီနူးဝင်ရောက်မရ'
  },

  test: {
    messages: {
      welcomeSent: '✅ ကြိုဆိုစာတမ်း စမ်းပို့ပြီး',
      quoteSent: '✅ နေ့စဉ်စကားစု စမ်းပို့ပြီး',
      milestoneSent: '✅ ခရီးရောက်စာတမ်း စမ်းပို့ပြီး',
      gratitudeSent: '✅ ကျေးဇူးတင်စာတမ်း စမ်းပို့ပြီး',
      safetySent: '✅ ဘေးကင်းရေး အသိပေးချက် စမ်းပို့ပြီး',
      highlightSent: '✅ လမ်းကြောင်း အထူးအကြောင်း စမ်းပို့ပြီး'
    },
    sending: {
      welcome: 'ကြိုဆိုစာတမ်း ပို့နေသည်...',
      quote: 'နေ့စဉ်စကားစု ပို့နေသည်...',
      milestone: 'ခရီးရောက်ခြင်း ပို့နေသည်...',
      gratitude: 'ကျေးဇူးတင်စာတမ်း ပို့နေသည်...',
      safety: 'ဘေးကင်းရေး အသိပေးချက် ပို့နေသည်...',
      highlight: 'လမ်းကြောင်း အထူးအကြောင်း ပို့နေသည်...'
    },
